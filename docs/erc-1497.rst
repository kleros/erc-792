...
``_metaevidence``. This string contains the URI from where the content of metaevidence can be fetched.
...
Congratulations, now this arbitrable is ERC-1497 compatible!
